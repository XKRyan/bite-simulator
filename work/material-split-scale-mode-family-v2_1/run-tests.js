...
const subject = require('./exact-mode-family-geometry-v2_1.js');
...
check('all source pins and non-authority declarations are exact', () => {
  assert.equal(subject.EXPECTED_MODE_FAMILY_SHA256,
    hashFile(path.resolve(__dirname, './mode-family-geometry-v2_1.js')));
...
process.stdout.write(`${JSON.stringify({ schema: 'exact-mode-family-geometry-tests-v1',
  ...
  sourceSha256: hashFile(path.resolve(__dirname, 'exact-mode-family-geometry-v2_1.js')) }, null, 2)}\n`);
