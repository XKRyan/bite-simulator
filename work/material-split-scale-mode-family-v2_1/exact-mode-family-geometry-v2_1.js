...
const modeFamilyModule = require('./mode-family-geometry-v2_1.js');
const exactAreaModule = require('../material-exact-triangle-sweep-area/exact-triangle-sweep-area.js');

const MODE_FAMILY_PATH = path.resolve(__dirname, './mode-family-geometry-v2_1.js');
const EXACT_AREA_PATH = path.resolve(__dirname, '../material-exact-triangle-sweep-area/exact-triangle-sweep-area.js');
const EXPECTED_MODE_FAMILY_SHA256 = '41B1CB64449BD7585675F275856EBC7E9FC081F354AE9AC2F411283F755B40C6';
